...
```
/dedup <module>             -> $MODULE = "<category>/<module>" (e.g. modules/forge-modules/<module>)
...
find ./modules -maxdepth 4 -type f \( -name "package.json" -o -name "pyproject.toml" \) | xargs -I {} dirname {} | sort -u
```
