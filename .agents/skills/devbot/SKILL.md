...
| CRUD route patterns    | [crud-patterns.md](crud-patterns.md)     | Creating or editing route files in `modules/forge-modules/devbot/backend/src/routes/`                                                                                          |
| Worker patterns        | [worker-patterns.md](worker-patterns.md) | Editing Claude CLI worker files in `modules/forge-modules/devbot/backend/src/lib/` (spawning, stream-json parsing, persistence, cleanup)                                       |
...
Module docs live in `modules/forge-modules/devbot/AGENTS.md` (architecture, database rules, autonomy rules).
