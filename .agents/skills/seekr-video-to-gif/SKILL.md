---
name: seekr-video-to-gif
description: Convert a video to an animated GIF with high quality palette optimization.
---
...
```bash
cd modules/meme-vault && npx tsx independent_node_skills/video-to-gif.ts \
