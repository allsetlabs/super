...
description: Comprehensive code review checklist for any module. 120+ checks across security, bugs, performance, TypeScript safety, React hooks, Node.js async, and database queries. Auto-triggers when reviewing PRs or completing feature work.
---
...
Typical module stack: Express + TypeScript + React 19 + TanStack Query + Capacitor. Apply the checks that match the module under review and skip sections for technologies it doesn't use (e.g. Supabase checks only where Supabase is used).
