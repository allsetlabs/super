---
name: seekr-upload-github-meme-vault-clip
description: Upload meme vault clip files to a GitHub repository.
---
...
```bash
cd modules/meme-vault && npx tsx independent_node_skills/upload-github.ts \
