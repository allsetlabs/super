---
name: seekr-download-yt-video
description: Download full videos or segments from YouTube.
---
...
```bash
cd modules/meme-vault && npx tsx independent_node_skills/download-yt-video.ts \
  --url <youtube-url>
```
