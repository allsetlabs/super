...
└── docs/decisions/     # ADRs for journal conventions
```

Each entry is YAML frontmatter (`date`, `people`, `tags`, `mood`, `location`, `summary`) followed by a markdown narrative. Search works by grepping frontmatter across `**/*.md` rather than a separate index — see [ADR 0001](../../journal/docs/decisions/0001-entry-layout-and-metadata.md).
...
- Module [AGENTS.md](../../journal/AGENTS.md)
- [Decision records](../../journal/docs/decisions/index.md)
