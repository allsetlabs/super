...
1. **Module organization** — [.agents/skills/super/standards/how-to-organize-module.md](.agents/skills/super/standards/how-to-organize-module.md). Read when adding, categorizing, or moving a module.
2. **Makefile** — [.agents/skills/super/standards/makefile.md](.agents/skills/super/standards/makefile.md). Read when onboarding a new module, or auditing an existing one.
3. **AGENTS.md that teaches judgment** — [.agents/skills/super/standards/agents-md.md](.agents/skills/super/standards/agents-md.md). Read before creating or updating any `AGENTS.md`/`CLAUDE.md`, in this repo or any module. Read when onboarding a new module, or auditing an existing one.
4. **Decision records** — [.agents/skills/super/standards/decision-records.md](.agents/skills/super/standards/decision-records.md). Read when recording an ADR, or for the pre-commit check on whether one is needed.
