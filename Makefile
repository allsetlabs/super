.PHONY: help setup-mac submodules clean tree-add tree-remove tree-list terminal
...
setup-mac:
	...
	@npm install -g @anthropic-ai/claude-code @openai/codex kimi-code 2>/dev/null || true
	@bash .kimi-code/setup-kimi-hooks.sh
