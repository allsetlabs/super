#!/usr/bin/env bash
# Copilot PostToolUse hook: after a git commit, run sync-docs and sync-api.
# Mirrors .claude/settings.json PostToolUse hook and .kimi-code/hooks/post-tool-use.sh.
